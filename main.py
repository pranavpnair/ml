...
subprocess.call('python models_predict.py shoppingListWithNoise.tsv >support_vectors',shell=True)
subprocess.call('python density.py noise_lines support_vectors > density',shell=True)
f=open("density")
